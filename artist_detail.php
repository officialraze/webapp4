						...
						<div class="popular_song">
							<div class="popular_song_inner">
								...
								<div class="song_information">
									...
									<h4 class="artist_name"><?php echo htmlspecialchars($artist_data['artist_firstname']).' '.htmlspecialchars($artist_data['artist_lastname']); ?><span class="play_counter"> • <?php echo $song_data['plays'].' Plays'; ?></span></h4>
								</div>
					...
					foreach (array_slice($data, 3) as $song_data) { ?>
						<div class="popular_song">
							<div class="popular_song_inner">
								...
								<div class="song_options">
									<span class="play_counter"><?php echo $song_data['plays']; ?></span>
									<span class="time"><?php echo $song_data['length']; ?></span>
